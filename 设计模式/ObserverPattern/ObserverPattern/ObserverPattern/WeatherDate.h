...
public:
	...
	void registerObserver(const std::shared_ptr<Observer> &rhs) override;//override明确声明要覆盖基类的virtual函数
	void removeObserver(const std::shared_ptr<Observer> &rhs) override;//override明确声明要覆盖基类的virtual函数
